...
export default function Footer() {
  return (
    ...
    <footer className='grid grid-cols-1 md:grid-cols-2  lg:grid-cols-4 gap-1 lg:gap-3 container text-center m-auto pt-5 pointer'>
      ...
      <div className='SpanHover' >
        ...
        <span className=''>
            <svg className="w-6 h-6 text-text-footer dark:text-gray-800" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
  ...
  <path d="M20.677 4.117A1.996 1.996 0 0 0 20 4H4c-.225 0-.44.037-.642.105l.758.607L12 10.742 19.9 4.7l.777-.583Z"/>
        ...
        <span className='px-2'>Eslam.mohamed.ki123@gmail.com</span> 
         ...
         <div className='flex py-2 align-baseline w-fit lg:me-auto m-auto'>
           <span className=''>
            ...
            <svg className="w-6 h-6 text-text-footer dark:text-black" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
         ...
         <div className='flex py-2 align-baseline  w-fit lg:me-auto m-auto'>
           <span className=''>
            ...
            <svg className="w-6 h-6 text-text-footer dark:text-gray-800" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
      ...
      <div className='SpanHover'>
          ...
          <div className='py-2'><span>للعمال</span></div>
          <div className='py-2'> <span>نشر عمل </span> </div>
          <div className='py-2'><span>عرض خدمات</span></div>
          <div className='py-2' > <span>المدونة</span> </div>
          </div>
      </div>
          ...
          <div className='py-2'> <Link href={''}> <span>كيف نعمل </span> </Link>  </div>
          <div className='py-2' > <Link href={''}> <span>الاسئله الشائعة</span> </Link> </div>
          <div className='py-2'> <Link href={''}> <span>سياسة الخصوصية</span> </Link> </div>
          <div className='py-2' > <Link href={''}> <span>شروط الاستخدام</span> </Link>  </div>
          </div>
      </div>

          <div className="  lg:text-right
          ">
          <h2 className='my-5 me-5 text-2xl'> <FaRegHandshake className='text-4xl inline-block'/> Instawork </h2>

          <div className='my-4 text-text-footer'>
          <p className='py-2 px-5'>منصة عمل حر مصممة خصيصًا لأصحاب المهن اليدوية في مصر. نربط بين العملاء والعمال المهرة بسهولة وأمان.</p>
          </div>
      </div>
